...
<script>
import { getUserToken, getBaseUrl } from '@/d/utils/utils'
...
export default {
  ...
  data() {
    return {
      ...
      init: {
        vue_this: this,
        language_url: '/static/d/tinymce/zh_CN.js',
        language: 'zh_CN',
        skin_url: '/static/d/tinymce/skins/ui/oxide',
        content_css:
            '/static/d/tinymce/skins/content/default/content.min.css',
